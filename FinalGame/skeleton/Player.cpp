...
{
	falcon = new Particle(5, Vector3(-1000, 0, 0), Vector4(1, 1, 1, 1), scene_, pxphy_, true, 0);//(10, Vector4(0.3, 0.3, 0.3, 1), Vector3(0, 0, 0), 0.0, 0, 0, 0);
...
void Player::setTrapped(bool value)
{
	trapped = value;
}
